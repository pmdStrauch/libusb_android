...
struct libusb_context {
	...
	/* used to see if the file descriptor has been opened externally and
	 * passed to libusb_open2(). In this case it has to remain opened after
	 * the libusb_close() call. */
	int fd_opened_externally;
